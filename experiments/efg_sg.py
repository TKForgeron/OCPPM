...
class EFG_SG(Dataset):
    ...
    TODO:
    - Fix BUG: when `skip_cache == False` an initialized `EFG_SG` object does not contain data
        - working solution for now, initialize it once with `skip_cache == False`,
        from then on use `skip_cache == True`
